...
public final class ChartResource {
    ...
    public Response render(ChartRequest request) {
        ...
        try (Context context = Context.newBuilder("js").
            ...
            String svg = renderBarChart.execute(validated.getTitle(), validated.getXLabel(), validated.getYLabel(),
                                                validated.getX(), validated.getY(),
                                                validated.getWidth(), validated.getHeight()).asString();
